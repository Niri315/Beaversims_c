export const HEALING_SPECS = [
    //{ id: "hpriest", label: "Holy Priest" },
    //{ id: "disc", label: "Discipline Priest" },
    { id: "hpal", label: "Holy Paladin" },
...
export const HERO_TALENTS = {
    //hpriest: ["Oracle", "Voidweaver"],
    //disc: ["Harbinger", "Inquisitor"],
    hpal: ["Lightsmith", "Herald of the Sun"],
